...
/*
 * #outline|(max heading level)| wiki block plugin
 *
 * usage:
 * <code>
 * #outline||
 ...
 * @version $Id: yb_plugin_wiki_outline.php 547 2009-07-14 05:29:59Z msakamoto-sf $
 * @param string plugin parameter
 * @param string inline text
 * @param wiki_Context reference
 * @return string
 */
function yb_plugin_wiki_outline_invoke_block($param1, $param2, &$ctx)
{
    $nest = intval(trim($param1));

    $src = yb_Wiki::displayed_source();
