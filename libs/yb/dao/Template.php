...
/**
 * YakiBiki Dao Template
 *
 * @author msakamoto-sf <msakamoto-sf@users.sourceforge.net>
 * @version $Id: Template.php 494 2009-01-04 02:23:39Z msakamoto-sf $
 */
 ...
 * @author msakamoto-sf <msakamoto-sf@users.sourceforge.net>
 */
class yb_dao_Template extends yb_dao_Base
{
    // {{{ constructor
     ...
     * @access private
     */
    function yb_dao_Template()
    {
        $this->_cache_name = __CLASS__;

        $this->_grain_name = 'template';

        $this->_sortable = array('id', 'name', 'created_at', 'updated_at');
    }
